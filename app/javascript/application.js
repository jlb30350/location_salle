...
form.action = `/rooms/${roomId}/reservations`;
...
document.addEventListener("turbo:load", () => {
  initializeLightbox(); // Assurez-vous que la fonction d'initialisation existe
});

document.addEventListener('DOMContentLoaded', function () {
  let roomId = document.getElementById('reservation-section').getAttribute('data-room-id');
  console.log('Room ID:', roomId);

  // Ensuite, utilisez `roomId` pour formater l'URL de soumission
});
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.available-day').forEach(function(button) {
    button.addEventListener('click', function() {
      ...
      console.log("Date cliquée : ", selectedDate); // Vérification du clic
  ...
  function submitReservation(startDate, endDate) {
    console.log("Envoi de la réservation pour les dates : ", startDate, endDate);
    const form = document.createElement('form');
    form.method = 'POST';
    form.action = '/bookings'; // Remplacez par l'URL correcte pour créer une réservation
    ...
    startDateInput.name = 'booking[start_date]';
    startDateInput.value = startDate;
    form.appendChild(startDateInput);

    const endDateInput = document.createElement('input');
    endDateInput.type = 'hidden';
    endDateInput.name = 'booking[end_date]';
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Gestion des clics sur les boutons de jours disponibles
  document.querySelectorAll('.available-day').forEach(function(button) {
    button.addEventListener('click', function() {
      const selectedDate = this.getAttribute('data-date');
      ...
      if (!firstDate) {
        ...
        // Après avoir sélectionné la deuxième date, soumettre le formulaire
        submitReservation(firstDate, lastDate);
      }
    });
  });
  ...
  function submitReservation(startDate, endDate) {
    ...
    // Création d'un formulaire pour soumettre les dates de réservation
    const form = document.createElement('form');
    form.method = 'POST';
    form.action = `/rooms/${roomId}/bookings`; // Remplacez par l'URL correcte de création de réservation
    ...
    // Ajout des dates de début et de fin de réservation
    const startDateInput = document.createElement('input');
    startDateInput.type = 'hidden';
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.available-day').forEach(function(button) {
    button.addEventListener('click', function() {
      const selectedDate = this.getAttribute('data-date');
      console.log("Date cliquée : ", selectedDate); // Pour voir si le clic est bien détecté
